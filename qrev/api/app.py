...
app = FastAPI(
    title="QReviewer API",
    description="Automated code review service for GitHub pull requests",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def root():
    ...
    <html>
        ...
        <body>
            <div class="container">
                <h1>🔍 QReviewer API</h1>
                <p>Welcome to the QReviewer API! This service provides automated code review for GitHub pull requests.</p>
